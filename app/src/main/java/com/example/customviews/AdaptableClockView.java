 ...
 */
public class AdaptableClockView extends View implements IClockView{
     ...
     */
    public AdaptableClockView(Context context) {
        this(context,null);
    }
     ...
     * @param attrs
     */
    public AdaptableClockView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
